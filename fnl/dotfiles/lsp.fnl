...
(defn on-attach [client bufnr]
  ...
  (if client.resolved_capabilities.code_action
    (do
      ...
      ; (util.bnoremap bufnr :n :<leader>ca ":Lyspsaga code_action<cr>")
  ...
  (util.noremap :n :<leader>k ":Lspsaga diagnostic_jump_next<cr>")
  (util.noremap :n :<leader>j ":Lspsaga diagnostic_jump_prev<cr>")
  ; (util.noremap :n :<leader>k "<cmd>lua vim.lsp.diagnostic.goto_prev()<CR>")
  ; (util.noremap :n :<leader>j "<cmd>lua vim.lsp.diagnostic.goto_next()<CR>"))
