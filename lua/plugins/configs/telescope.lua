...
return wk.register({tg = {name = "Telescope git", b = {"<cmd>Telescope git_branches<cr>", "Open git branches"}, C = {"<cmd>Telescope git_commits<cr>", "Open git commits"}, c = {"<cmd>Telescope git_bcommits<cr>", "Open current file commits"}, s = {"<cmd>Telescope git_status<cr>", "Open git status"}}}, {prefix = "<leader>"})
