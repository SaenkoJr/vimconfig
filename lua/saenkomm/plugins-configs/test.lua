-- [nfnl] Compiled from fnl/saenkomm/plugins-configs/test.fnl by https://github.com/Olical/nfnl, do not edit.
module(saenkomm.plugins.test, {[require] = {[c] = aniseed.core, [util] = saenkomm.util}})
