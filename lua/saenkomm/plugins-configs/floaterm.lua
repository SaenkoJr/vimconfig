-- [nfnl] Compiled from fnl/saenkomm/plugins-configs/floaterm.fnl by https://github.com/Olical/nfnl, do not edit.
module(saenkomm.plugins.floaterm, {[require] = {[util] = saenkomm.util}})
